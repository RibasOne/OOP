...
public class Console {
    ...
    private void adicionarDespesa(){
        ...
        if(opcaoContinuar.charAt(0) == 'N'){
            if(projeto != null){
                System.out.println("Custo total do projeto: " + projeto.calcularCustoTotal());
                System.out.println("Valor a ser cobrado do cliente: " + projeto.calcularPrecoFinal());
            }else{
                System.out.println("O projeto não foi criado. Não é possível calcular o custo do projeto e do cliente.");
            }
        }
    }
}